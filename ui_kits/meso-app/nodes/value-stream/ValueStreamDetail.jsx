...
const ValueStreamDetail = ({ valueStream, onTitleVisibilityChange }) => {
  const detail = getValueStream(valueStream)

  const tabs = [
    { id: 'about',        label: 'About',        content: <AboutTab        detail={detail} /> },
    { id: 'contributors', label: 'Contributors',  badge: String(detail.contributors.length),   content: <ContributorsTab detail={detail} /> },
    { id: 'processes',    label: 'Processes',     badge: String(detail.processes.length),       content: <ProcessesTab    detail={detail} /> },
    { id: 'capabilities', label: 'Capabilities',  badge: String(detail.capabilities.length),   content: <CapabilitiesTab detail={detail} /> },
    { id: 'kpis',         label: 'KPIs',          badge: String(detail.kpis.length),            content: <KPIsTab         detail={detail} /> },
  ]

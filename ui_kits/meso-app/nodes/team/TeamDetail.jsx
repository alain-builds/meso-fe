...
const DEFAULTS = {
  ...
  members: [
    { id: 'm1', name: 'Sarah van der Berg', role: 'Engineering Manager',   isVacant: false, isExternal: false, staffedAt: 'Mar 2022', legalEntity: 'Acme Inc' },
    { id: 'm2', name: 'Thomas Weber',       role: 'Staff Engineer',        isVacant: false, isExternal: false, staffedAt: 'Jun 2022', legalEntity: 'Acme Inc' },
    { id: 'm3', name: 'Katarina Novak',     role: 'SRE Lead',              isVacant: false, isExternal: false, staffedAt: 'Jan 2023', legalEntity: 'Acme Inc' },
    { id: 'm4', name: 'Jin Park',           role: 'Senior Engineer',       isVacant: false, isExternal: false, staffedAt: 'Apr 2023', legalEntity: 'Acme Inc' },
    { id: 'm5', name: 'Anika Bauer',        role: 'Senior Engineer',       isVacant: false, isExternal: false, staffedAt: 'Sep 2023', legalEntity: 'Acme Inc' },
    { id: 'm6', name: 'Remi Fontaine',      role: 'Senior Engineer',       isVacant: false, isExternal: true,  staffedAt: 'Feb 2024', legalEntity: 'Deloitte'      },
    { id: 'm7', name: 'Lars Eriksson',      role: 'Engineer',              isVacant: false, isExternal: false, staffedAt: 'May 2024', legalEntity: 'Acme Inc' },
    { id: 'm8', name: 'Mia Santos',         role: 'Engineer',              isVacant: false, isExternal: true,  staffedAt: 'Nov 2024', legalEntity: 'Accenture'     },
    { id: 'm9', name: '',                   role: 'Senior Engineer',       isVacant: true,  isExternal: false, staffedAt: null,        legalEntity: null            },
    { id: 'm10',name: '',                   role: 'On-call escalation',    isVacant: true,  isExternal: false, staffedAt: null,        legalEntity: null            },
  ],
...
const TEAM_DETAILS = {
  t2: {
    ...
    members: [
      { id: 'm1', name: 'Marco Lehmann', role: 'Engineering Manager', isVacant: false, isExternal: false, staffedAt: 'Jun 2022', legalEntity: 'Acme Inc' },
      { id: 'm2', name: 'Priya Nair',    role: 'Data Engineer',       isVacant: false, isExternal: false, staffedAt: 'Oct 2022', legalEntity: 'Acme Inc' },
      { id: 'm3', name: 'Ahmed Hassan',  role: 'Data Engineer',       isVacant: false, isExternal: true,  staffedAt: 'Mar 2024', legalEntity: 'Capgemini'     },
      { id: 'm4', name: '',              role: 'Staff Data Engineer',  isVacant: true,  isExternal: false, staffedAt: null,        legalEntity: null            },
    ],
  ...
  t3: {
    ...
    members: [
      { id: 'm1', name: '',            role: 'Head of Security & Compliance', isVacant: true,  isExternal: false, staffedAt: null,        legalEntity: null            },
      { id: 'm2', name: 'Ana Petrova', role: 'Security Engineer',             isVacant: false, isExternal: false, staffedAt: 'Oct 2023', legalEntity: 'Acme Inc' },
      { id: 'm3', name: 'Omar Aziz',   role: 'Compliance Analyst',            isVacant: false, isExternal: false, staffedAt: 'Jan 2024', legalEntity: 'Acme Inc' },
    ],
    directMemberCount: 3, totalMemberCount: 3,
    directInternalMemberCount: 2, directExternalMemberCount: 0,

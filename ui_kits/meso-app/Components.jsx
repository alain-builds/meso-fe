...
const Icon = ({ name, size = 20, color = 'currentColor', strokeWidth = 1.5, style = {} }) => {
  const paths = {
    ...
    'grid-3x3':         <><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" x2="9" y1="3" y2="21"/><line x1="15" x2="15" y1="3" y2="21"/><line x1="3" x2="21" y1="9" y2="9"/><line x1="3" x2="21" y1="15" y2="15"/></>,
